...
echo "fs_defaultFS:"$CORE_CONF_fs_defaultFS
...
if [ -n "$GANGLIA_HOST" ]; then
    ...
    echo "Configuring -module in mapred jvm rpc ugi-"
    ...
    echo "Configuring -namenode datanode resourcemanager nodemanager mrappmaster jobhistoryserver-"
